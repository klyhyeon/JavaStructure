package javastructure.ListStructure;
...
public class MyArrayList<T> implements List<T> {
    ...
    public T remove(int index) {
        // TODO: FILL THIS IN!
        //length가 array length의 -1인 배열을 만든다음 원래 배열을 복붙
//        T removedElement = array[index];
//        if (index < 0 || index > size) {
//            throw new IndexOutOfBoundsException();
//        }
//        T[] smaller = (T[]) new Object[array.length - 1];
//        if (index == 0) {
//            System.arraycopy(array, 1, smaller, index, smaller.length);
//        } else {
//            System.arraycopy(array, index + 1, smaller, index, array.length - index - 1);
//            System.arraycopy(array, 0, smaller, index - 1, index - 1);
//        }
